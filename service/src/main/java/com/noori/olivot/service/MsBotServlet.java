 ...
 */
public final class MsBotServlet extends HttpServlet {
    private static Logger logger = Logger.getLogger(MsBotServlet.class.getName());
    ...
    /**
     * Initializes new instance of {@link MsBotServlet}
     */
    public MsBotServlet() {
        this(new MsBotImpl());
    }

    public MsBotServlet(ChatBot bot) {
