 ...
 *******************************************************************************/
package com.noori.komoran.core;

import kr.co.shineware.ds.aho_corasick.FindContext;
import com.noori.komoran.constant.DEFAULT_MODEL;
import com.noori.komoran.constant.FILENAME;
import com.noori.komoran.constant.SCORE;
import com.noori.komoran.constant.SYMBOL;
import com.noori.komoran.core.model.ContinuousSymbolInfo;
import com.noori.komoran.core.model.Lattice;
import com.noori.komoran.core.model.LatticeNode;
import com.noori.komoran.core.model.Resources;
import com.noori.komoran.corpus.parser.CorpusParser;
import com.noori.komoran.corpus.parser.model.ProblemAnswerPair;
...
import com.noori.komoran.model.Tag;
...
//        String cPath = "";
//        try {
//			cPath = f.getCanonicalPath().toString();  //cPath+File.separator+"../../../../../../../../../"+File.separator+
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
...
//					lattice.put(this.prevBeginIdx, endIdx, this.prevMorph, this.prevPos, this.resources.getTable().getId(this.prevPos), SCORE.SN);
    ...
    public void load(String modelPath) {
        ...
        System.out.println("##### resources load complete");
    }
