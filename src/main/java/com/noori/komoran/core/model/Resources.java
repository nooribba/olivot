...
import com.noori.komoran.modeler.model.IrregularTrie;
...
public class Resources {
	...
	public void load(String path) {
		this.init();
		System.out.println("##### resource load start(pos table):"+path+File.separator+FILENAME.POS_TABLE);
		this.table.load(path+File.separator+FILENAME.POS_TABLE);
		System.out.println("##### resource load complete(pos table)");
